    ...
    >
      <VStack space="lg">
        ...
        <Input
          ...
          isReadOnly={false}
        >
          <InputField placeholder="Password" keyboardType="visible-password" />
        </Input>
      </VStack>
            ...
            <SelectPortal>
              ...
              <SelectContent>
                ...
                <SelectItem
                  ...
                  value="none"
                />
                <SelectItem label="A little (1 to 3 hours)" value="little" />
                <SelectItem label="Some (4 to 6 hours)" value="some" />
                <SelectItem label="A lot (7 to 9 hours per week)" value="lot" />
                <SelectItem label="A ton (10+ hours per week)" value="ton" />
              </SelectContent>
            </SelectPortal>
          </Select>
        </VStack>
